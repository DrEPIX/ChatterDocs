...
export function createDemoRooms() {
  ...
  if (roomCount === 0) {
    const insert = db.prepare(
      'INSERT INTO rooms (id, name, type, description, minecraft_host, minecraft_port, minecraft_version) VALUES (@id, @name, @type, @description, @minecraft_host, @minecraft_port, @minecraft_version)'
    );
    insert.run({
      id: nanoid(12),
      name: 'Lobby',
